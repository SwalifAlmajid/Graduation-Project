        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <View style={{ flexDirection: "row", flexWrap: "nowrap", marginBottom: 10 }}>
              ...
              <Text style={{ marginBottom: 5, fontWeight: "600" }}>اسم العنوان</Text>
              <TextInput
                value={customName}
              ...
              <TouchableOpacity
                style={[
                  styles.addressTypeOvalBtn,
                  { marginTop: 10, width: "100%", backgroundColor: "#63A874", borderColor: "#63A874" },
                ]}
                onPress={handleSaveAddress}
              >
                <Text style={[styles.addressTypeBtnText, { color: "#fff" }]}>
                  حفظ العنوان
                </Text>
              </TouchableOpacity>

              <TouchableOpacity
                style={[styles.addressTypeOvalBtn, { backgroundColor: "#ddd", marginTop: 10, width: "100%" }]}
                onPress={() => setModalVisible(false)}
              >
                <Text style={[styles.addressTypeBtnText, { color: "#333" }]}>إلغاء</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Modal>
...
const styles = StyleSheet.create({
  ...
  whiteContainer: { flex: 1, backgroundColor: "#fff", borderTopLeftRadius: 40, borderTopRightRadius: 40, padding: 25 },
  map: { width: "100%", height: 250, borderRadius: 20, marginBottom: 15 },
  currentLocationBtn: { position: "absolute", top: 210, right: 30, backgroundColor: "#63A874", padding: 12, borderRadius: 30, zIndex: 10 },
  saveLocationBtn: { backgroundColor: "#63A874", paddingVertical: 12, borderRadius: 12, marginBottom: 15 },
  sectionTitle: { fontSize: 16, fontWeight: "700", marginBottom: 10, color: "#000" },
  addressCard: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#f9f9f9", padding: 16, borderRadius: 14, borderWidth: 1, borderColor: "#eee", marginBottom: 12 },
